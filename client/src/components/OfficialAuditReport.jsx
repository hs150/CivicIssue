  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="relative w-full max-w-4xl rounded-3xl bg-white shadow-2xl border border-slate-200 my-8 overflow-hidden">
        ...
        <div className="print:hidden flex items-center justify-between border-b border-slate-200 px-6 py-4 bg-black text-white">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={handlePrint}
              className="inline-flex items-center gap-1.5 rounded-xl bg-white text-black hover:bg-neutral-200 px-4 py-2 text-xs font-bold shadow-md transition active:scale-95"
            >
              <Printer size={14} /> Print / Save as PDF
            </button>
            <button
              onClick={onClose}
              className="rounded-xl p-2 text-neutral-400 hover:text-white hover:bg-white/10 transition"
              aria-label="Close"
            >
              <X size={18} />
            </button>
        ...
        <div ref={printRef} className="p-8 sm:p-12 text-slate-900 bg-white font-serif print:p-6 print:m-0">
          ...
          <div className="border-b-2 border-slate-900 pb-6 text-center relative">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-between gap-2 text-xs font-mono border-t border-slate-200 pt-3 text-slate-600">
              ...
              <span className="text-slate-950 font-bold">STATUS: AUTHENTICATED & VERIFIED</span>
            </div>
          </div>
          ...
          <div className="my-6 rounded-2xl border-2 border-slate-900 p-4 bg-slate-50/50 font-sans flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <div className="h-12 w-12 rounded-xl bg-slate-950 text-white grid place-items-center shrink-0">
                <ShieldCheck size={26} />
              </div>
              <div>
            ...
            <div className="flex items-center gap-3 shrink-0">
              <div className="text-right">
                ...
                <p className="text-xl font-black text-slate-950">{matchScore}%</p>
              </div>
          ...
          <div className="font-sans text-xs my-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4 rounded-xl bg-slate-100/70">
              ...
              <div>
                ...
                <span className="font-bold text-slate-900 font-mono">{(issue.phase || issue.status || "").replace(/_/g, " ")}</span>
              </div>
            </div>
          ...
          {v.summary && (
            <div className="font-sans text-xs my-4 p-4 rounded-xl bg-slate-50 border border-slate-200">
              <p className="font-bold text-slate-900 mb-1 flex items-center gap-1.5">
                <ShieldCheck size={14} className="text-slate-900" /> AI Comparison Finding:
              </p>
          ...
          <div className="font-sans mt-8 pt-6 border-t-2 border-slate-900 grid grid-cols-2 sm:grid-cols-3 gap-6 text-xs">
            ...
            <div className="sm:text-right col-span-2 sm:col-span-1 border-t sm:border-t-0 pt-3 sm:pt-0">
              ...
              <p className="text-[10px] text-slate-900 font-bold mt-0.5">✓ Cryptographically Sealed</p>
            </div>
          </div>
        </div>
      </div>
