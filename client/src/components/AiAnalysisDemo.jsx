      ...
      <div className="rounded-3xl bg-black text-white p-6 sm:p-10 lg:p-14 shadow-2xl border border-neutral-800 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            {/* Pill: VERIFICATION */}
            <div className="inline-flex items-center gap-1.5 rounded-full bg-neutral-900 border border-neutral-700 px-3 py-1 text-[11px] font-mono font-bold text-white">
            ...
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight text-white leading-tight">
              Verified Issues. <br />
              <span className="text-white underline decoration-neutral-500 underline-offset-4">Real Action.</span>
            </h2>
            ...
            {issues.length > 1 && (
              <div className="pt-1">
                <select
                  ...
                  className="rounded-xl border border-neutral-700 bg-neutral-900 px-3 py-2 text-xs font-mono text-neutral-200 focus:border-white focus:outline-none"
                >
                  {issues.map(i => (
            ...
            <div className="pt-2">
              <Link
                to={`/issues/${issue.id}`}
                className="inline-flex items-center gap-2 rounded-full bg-white hover:bg-neutral-200 px-5 py-2.5 text-xs font-bold text-black transition shadow-sm"
              >
          ...
          <div className="lg:col-span-5">
            <div className="relative aspect-4/3 w-full rounded-2xl overflow-hidden border border-neutral-800 bg-neutral-950 shadow-xl group">
              ...
              <div
                ...
                className="h-full w-full items-center justify-center bg-neutral-900 text-neutral-500 text-xs font-mono"
              >
                No image uploaded for this issue
              </div>

              {/* Monochrome Bounding Box */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-44 sm:w-56 h-28 sm:h-36 rounded-xl border-2 border-white bg-white/10 flex items-center justify-center pointer-events-none shadow-[0_0_15px_rgba(255,255,255,0.25)]">
                <span className="rounded-md bg-black/90 border border-white/60 px-2.5 py-1 text-[11px] font-mono font-bold text-white shadow-md uppercase">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            {/* 4 Checklist Items with Monochrome Check Circles */}
            <div className="space-y-3.5">
              {checklist.map((item) => (
                <div key={item.id} className="flex items-start gap-2.5">
                  <div className="mt-0.5 flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-white text-black">
